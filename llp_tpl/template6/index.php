            ...
            <div id="content">
                <div class="video-course">
                    ...
                    <div id="lb-fade-box" style="display: block; opacity: 1;">
                        <a id="llp_button_1" data-replace-right=' <img src="<?php echo llp_URL; ?>/llp_tpl/<?php echo $get_llp_tpl->tmp_file; ?>/images/btnarrow.png" class="img8">' data-heading="Button" data-id="4" data-edit="true" data-type='link' data-default='<?php echo $llp_button_1; ?>' data-wp_custom_field='llp_button_1' data-link='<?php echo $llp_button_1_link_a; ?>' data-target='1' href="<?php echo $llp_button_1_link_a; ?>" class="yellow-btn llp_box" <?php if ($llp_button_1_link_a_open != "") { ?>target="_blank"<?php } ?>><?php echo $llp_button_1; ?> <img src="<?php echo llp_URL; ?>/llp_tpl/<?php echo $get_llp_tpl->tmp_file; ?>/images/btnarrow.png" class="img8"></a>
                    </div>
